...
Shader "PIDI Shaders Collection/XFur System/Standard/High Quality/Four Samples" {
	Properties {
		...
		[PerRendererData]_FurStep("Fur Step", Float) = 32
		[PerRendererData]_ShadowLayerIndex("Shadow Layer Index",Float) = 0
		...
		[PerRendererData]_SkinMode("Render Skin Mode", Float ) = 1
